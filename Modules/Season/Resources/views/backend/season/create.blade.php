                    ...
                    {{-- <div class="col-md-4 position-relative">
                        ...
                        <div class="uploaded-image mt-2" id="selectedImageContainerSeo">
                         ...
                         @error('seo_image')
                            ...
                            <!-- Invalid Feedback -->
                            <div class="invalid-feedback" id="embed-error">image is required</div>
                    </div> --}}
        ...
        form.addEventListener('submit', function (e) {
            ...
            if (trailerType === 'Embedded') {
             ...
             if (!isValid) {
                e.preventDefault();
                return false;
                $('#submit-button-video').prop('disabled', false).html('<span class="spinner-border spinner-border-sm"></span> {{ trans("messages.save") }}');
