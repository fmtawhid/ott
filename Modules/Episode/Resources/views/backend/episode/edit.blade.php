                    ...
                    <div class="col-md-6 col-lg-4 d-none" id="url_input">
                        ...
                        <div id="embedded_input" class="d-none">
                            {{ html()->textarea('trailer_url_embedded')
                                ->placeholder(__('messages.lbl_embed_code'))
                                ->class('form-control')
...
document.addEventListener('DOMContentLoaded', function () {
    // Live validation
    [
        { id: 'video_url_embedded', error: 'url-pattern-error' },
        { id: 'trailer_url_embedded', error: 'trailer-pattern-error' }
    ].forEach(({ id, error }) => {
    ...
    if (submitButton) {
        submitButton.addEventListener('click', function(e) {
            ...
            if (trailerType === 'Embedded') {
                trailerIsValid = validateEmbedInput('trailer_url_embedded', 'trailer-pattern-error');
            }
